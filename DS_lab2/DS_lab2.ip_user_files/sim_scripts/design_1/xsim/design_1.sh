...
#
# Generated by Vivado on Thu Mar 18 18:13:48 +0100 2021
...
xv_boost_lib_path=D:/program/vivado/Vivado/2020.1/tps/boost_1_64_0
xvlog_opts="--relax"
xvhdl_opts="--relax"
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xpm -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip --snapshot design_1 xil_defaultlib.design_1 xil_defaultlib.glbl -log elaborate.log
}
...
{
  file="xsim.ini"
  lib_map_path="D:/program/vivado/Vivado/2020.1/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
