...
HD_PWD='D:/study/digital_system/vhdl_studies/DS_lab2/DS_lab2.runs/design_3_clk_wiz_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_3_clk_wiz_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_3_clk_wiz_0_0.tcl
